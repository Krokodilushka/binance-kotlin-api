...
class BinanceApiMarginRestClientImpl(
    apiKey: String?,
    secret: String?,
    baseUrl: String
) : BinanceApiMarginRestClient {
    ...
    override fun forceLiquidationRec(
        startTime: Long?,
        endTime: Long?,
        isolatedSymbol: Boolean?,
        current: Long?,
    ...
    override fun newIsolatedTransfer(
        asset: String,
        symbol: String,
