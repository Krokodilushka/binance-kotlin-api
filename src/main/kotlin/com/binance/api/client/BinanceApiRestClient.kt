...
interface BinanceApiRestClient {
     ...
     */
    fun getAggTrades(symbol: String?, fromId: String?, limit: Int?, startTime: Long?, endTime: Long?): List<AggTrade>?
     ...
     */
    fun getCandlestickBars(symbol: String?, interval: CandlestickInterval, limit: Int?, startTime: Long?, endTime: Long?): List<Candlestick>?
     ...
     */
    fun getAll24HrPriceStatistics(): List<TickerStatistics>
     ...
     */
    fun getBookTickers(): List<BookTicker>
    // Account endpoints
    /**
     * Send in a new order.
     *
     ...
     */
    fun getMyTrades(symbol: String?, limit: Int?, fromId: Long?, recvWindow: Long?, timestamp: Long?): List<Trade>
     ...
     */
    fun getDepositHistory(asset: String?): DepositHistory
     ...
     */
    fun getWithdrawHistory(asset: String?): WithdrawHistory
